...
export const enum ScenarioType {
  ...
  IMPERSONATION_THEFT = "IMPERSONATION_THEFT",
  AI_GENERATED_INTELLECT = "AI_GENERATED_INTELLECT",
  COLLUSION_R_COHORT = "COLLUSION_R_COHORT",
}
...
export enum ActiveTab {
  ...
  BEHAVIORAL_IDENTITY_PROFILE = 'BEHAVIORAL_IDENTITY_PROFILE',
